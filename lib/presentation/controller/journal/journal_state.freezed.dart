...
mixin _$JournalState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Journal?> journals) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Journal?> journals)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<Journal?> journals})
      : _journals = journals;
  ...
  @override
  String toString() {
    return 'JournalState.success(journals: $journals)';
  }
...
abstract class _Success implements JournalState {
  const factory _Success({required final List<Journal?> journals}) =
      _$SuccessImpl;
